...
patchBrowser().then(async (options) => {
  ...
  return index.bootstrapLazy([["stc-button_3.cjs",[[772,"stc-modal",{"open":[1540],"title":[1]},[[8,"keydown","onKeyDown"]]],[514,"stc-input",{"label":[1],"placeholder":[1],"value":[1025],"disabled":[4],"state":[1],"helperText":[1,"helper-text"]}],[774,"stc-button",{"variant":[1],"size":[1],"disabled":[516],"loading":[4]}]]]], options);
});
